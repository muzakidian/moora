    ...
    <nav class="settings-sidebar">
      <div class="sidebar-body">
        ...
        <div class="theme-wrapper">
          ...
          <a class="theme-item active" href="<?php echo base_url() ?>demo_1/dashboard-one.html">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-xl-8 stretch-card">            
			...
			<footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
				<p class="text-muted text-center text-md-left">Copyright © 2022 <a href="https://www.nobleui.com" target="_blank">Ruang Bit</a>. All rights reserved</p>
